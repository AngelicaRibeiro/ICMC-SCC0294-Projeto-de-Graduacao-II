...
% ---
\titulo{Titulo do TCC}
\autor[Gôlo, M. P. S.]{Marcos Paulo Silva Gôlo}
\orientador[Orientador:]{Prof. Dr.}{Ricardo Marcondes Marcacini}
%\coorientador{Prof. Dr.}{Fulano de tal}
\curso{Computação}
\area{Sistemas Computacionais} % Área de concentração do trabalho
\data{31}{05}{2015} % Data do depósito
% ---
...
\chapter{Novo Cap}
\label{chapter:newcap}
\input{tex/capitulos/newcap}
